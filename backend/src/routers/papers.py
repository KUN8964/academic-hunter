...
from ..schemas import PaperResponse, SearchRequest, SearchResponse
...
async def search_papers(
    ...
    """Search papers by title or abstract (ILIKE for case-insensitive). Does not require a subscription."""
    search_term = f"%{q}%"
